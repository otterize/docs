...
The Otterize [SPIRE integration operator](concepts/otterize-oss/componentsspire-integration-operator) automatically resolves pods to dev-friendly service names, registers them with a SPIRE server, and provisions credentials as a Kubernetes Secrets.
