...
- [Interact with](#network-mapper) the [Otterize network mapper](/k8s-network-mapper) running in a Kubernetes cluster.
...
:::danger
Update this after the implementation is fixed.
:::
...
:::danger
Update this after the implementation is restored to how it should be.
:::
...
:::danger
Document after getting this to work rather than returning a 404
:::
