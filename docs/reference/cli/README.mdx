...
Returns the list of (declared) intents, optionally filtered by client, server, or environment.
...
Returns information about a single (declared) intent, specified by its id.
