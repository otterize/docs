...
When installing Otterize, the intents operator can be [configured](/reference/intents-operator/helm-chart) to enforce access controls and protect services, or not.
