...
## Pod annotations
ORIORIORI - maybe we don't need this anymore? Followup after discussion with Omri
...
See [workload identities and resolution](/reference/service-identities) to learn how service names are resolved for pods.
...
See [workload identities and resolution](/reference/service-identities) to learn how workload identity is resolved for pods.
