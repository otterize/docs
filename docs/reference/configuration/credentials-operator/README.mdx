...
The Credentials operator is controlled using annotations placed on pods. To have it create credentials, you must specify `credentials-operator.otterize.com/tls-secret-name`.
