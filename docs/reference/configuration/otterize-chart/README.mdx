...
:::note
The [network mapper](concepts/otterize-oss/componentsnetwork-mapper) is not deployed by this chart. You can deploy it with [its own chart](otterize-oss/components/network-mapper/helm-chart).
:::end
...
Further information about the intents operator parameters can be found [in the Intents Operator's helm chart](otterize-oss/components/intents-operator/helm-chart).
...
Further information about credentials operator parameters can be found [in the credentials operator chart](otterize-oss/components/credentials-operator/helm-chart).
