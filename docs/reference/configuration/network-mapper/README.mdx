...
or the [more realistic example](/realistic-example/shadow-mode-network-policies). Here's an example output for running the network mapper following the example:
```shell
