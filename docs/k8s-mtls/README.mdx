...
[Otterize SPIRE integration operator documentation](/components/spire-integration-operator/).
:::
...
- Configure secure access between pods and Kafka running within the same Kubernetes cluster with this [guide](/guides/ibac-for-k8s-kafka/).
- Read more about the [Otterize SPIRE integration operator](/components/spire-integration-operator/)
