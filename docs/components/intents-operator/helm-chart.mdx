...
| `operator.autoGenerateTLSUsingSpireIntegration` | If true, adds the necessary pod annotations in order to generate mTLS credentials using the Otterize SPIRE integration operator. | `false`            |
