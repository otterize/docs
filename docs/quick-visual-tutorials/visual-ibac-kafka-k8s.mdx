...
kubectl apply -n otterize-ecom-kafka-demo -f ${ABSOLUTE_URL}/code-examples/shadow-mode/ecom-demo-mtls.yaml
```
...
```bash
kubectl apply -n otterize-ecom-kafka-demo -f ${ABSOLUTE_URL}/code-examples/shadow-mode/all.yaml
```
...
```bash
kubectl apply -n otterize-ecom-kafka-demo -f ${ABSOLUTE_URL}/code-examples/shadow-mode/kafkaserverconfig.yaml
```
<details>
...
```bash
kubectl apply -n otterize-ecom-kafka-demo -f ${ABSOLUTE_URL}/code-examples/shadow-mode/kafka-intents.yaml
```
...
```bash
kubectl delete -n otterize-ecom-kafka-demo -f ${ABSOLUTE_URL}/code-examples/shadow-mode/all.yaml
```

Next, remove the Kafka server config:
```bash
kubectl delete -n otterize-ecom-kafka-demo -f ${ABSOLUTE_URL}/code-examples/shadow-mode/kafkaserverconfig.yaml
```
Finally, remove the demo services and the namespace:
```bash
kubectl delete -n otterize-ecom-kafka-demo -f ${ABSOLUTE_URL}/code-examples/shadow-mode/ecom-demo-mtls.yaml
