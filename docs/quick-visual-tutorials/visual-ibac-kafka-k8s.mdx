...
:::danger
Please redo the above image with the KSC and Certificate information sections expanded, so the reader can see what is discussed in the following points.
:::
