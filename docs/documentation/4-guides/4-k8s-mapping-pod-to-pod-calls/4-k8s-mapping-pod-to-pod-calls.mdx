...
```bash
otterize intents list -n {NAMESPACE}
```

For the complete list of the otterize network mapper capabilities as read the [CLI command reference](/documentation/cli/#network-mapper).
...
:::tip
To learn more about how to use ClientIntents CRDs to manage network policies read this [guide](/documentation/guides/k8s-ibac-via-network-policies/)
:::

## What's next

- Use your mapped traffic as intents and implement [IBAC via network policies](/documentation/guides/k8s-ibac-via-network-policies/).
