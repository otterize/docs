...
- Learn how to configure your existing code to use mTLS for [HTTPS](/documentation/service-identities/using-credentials/#http)
(clients and servers) and for [Kafka clients](/documentation/service-identities/using-credentials/#kafka).
- Configure secure access between pods and Kafka with this [guide](/documentation/guides/ibac-for-k8s-kafka/).