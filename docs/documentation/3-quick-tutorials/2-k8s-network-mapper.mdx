...
helm repo update
helm upgrade --install -n otterize --create-namespace otterize/network-mapper
Download and extract the appropriate CLI for you: https://github.com/otterize/otterize-cli/releases/tag/v0.1.0
(TODO Tomer: replace with separate link and instructions for Windows, Mac, Linux)
```
