...
[Otterize Credentials operator documentation](otterize-oss/components/credentials-operator/).
:::
...
- Read more about the [Otterize Credentials operator](otterize-oss/components/credentials-operator/)
