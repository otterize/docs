...
[Otterize Credentials operator documentation](concepts/otterize-oss/componentscredentials-operator/).
:::
...
- Read more about the [Otterize Credentials operator](concepts/otterize-oss/componentscredentials-operator/)
