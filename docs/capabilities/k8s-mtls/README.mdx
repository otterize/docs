...
You can see a simple example in the tutorial: [deploy mTLS between pods](/capabilities/k8s-mtls).
...
[Otterize SPIRE integration operator documentation](concepts/otterize-oss/componentsspire-integration-operator/).
:::
...
- Configure secure access between pods and Kafka running within the same Kubernetes cluster with this [guide](/capabilities/kafka/).
- Read more about the [Otterize SPIRE integration operator](concepts/otterize-oss/componentsspire-integration-operator/)
