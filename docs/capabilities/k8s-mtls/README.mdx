...
[Otterize SPIRE integration operator documentation](concepts/otterize-oss/componentscredentials-operator/).
:::
...
- Read more about the [Otterize SPIRE integration operator](concepts/otterize-oss/componentscredentials-operator/)
