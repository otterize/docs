...
[documentation](otterize-oss/components/credentials-operator/).
...
[Read more about Kafka configuration here.](otterize-oss/components/intents-operator/configuration).
