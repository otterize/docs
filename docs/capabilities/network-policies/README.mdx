...
1. [Install](/k8s-network-mapper#install-the-network-mapper) the network mapper and Otterize CLI
...
```bash
otterize network-mapper export -n otterize-ecom-demo -o intents.yaml
```
