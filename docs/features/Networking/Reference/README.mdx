...
spec:
  service:
    name: client #The name of the service initiating the connection
  calls:
    - name: server #The name of the service recieving the connection. Multiple names can be provided
```
