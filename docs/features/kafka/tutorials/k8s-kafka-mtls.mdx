...
![Clients blocked](/img/quick-tutorials/k8s-kafka-mtls/client-blocked.png)

### What did we accomplish?

- Controlling Kafka access no longer means touching ACLs, issuing, managing and distributing certs, establishing trust,
  etc.
...
- The next `kubectl apply` you'll run will ensures that all the appropriate certs are issued and distributed,
