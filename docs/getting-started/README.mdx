...
* [Network policies](/build-confidence/shadow-mode-network-policies) - use shadow mode to boost confidence when rolling out secure access.
* [Secure access to Kafka](/build-confidence/visualize-kafka-protection) - visualize kafka configuration and changes.
