...
### Cluster local
The cluster local components are standalone open-source projects that implement intent-based access control (IBAC) for a single Kubernetes cluster. This same set of components are used to integrate with Otterize Cloud.
