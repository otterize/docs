...
- One service named "**client-other**".
- And one service named "**client-authenticated**".
...
Now click on the Kafka broker itself, and click at the bottom of it to focus on it and show its details:

:::danger
Evya to add screenshot of the details
:::

We can see `client`, `client-other` and `client-authenticated`, and how each accesses this Kafka broker.
