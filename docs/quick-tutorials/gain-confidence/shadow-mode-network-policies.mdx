...
```yaml
{@include: ../../..//static/code-examples/shadow-mode/phase-2-only.yaml}
```
...
## What's next
- Learn how to [manage secure access for Kafka](/quick-tutorials/gain-confidence/visualize-kafka-protection) using the demo lab tutorial.
...
kubectl delete -n otterize-ecom-demo -f code-examples/shadow-mode/ecom-demohelm .yaml
