...
Otterize Cloud allows you to visualize that data in the [access graph](https://app.otterize.com).
...
- Explore how [Shadow Mode](/realistic-example/shadow-mode-network-policies) can expand these capabilities.
