...
:::info
<!-- FIXME -->
See the [network mapper documentation](/components/network-mapper/readme) for more details about the CLI.
:::
...
6. And compare the original file with the updated file using:
   ...
   ```
   You should see a result looking like the following:
   ```bash
...
helm uninstall -n otterize-system network-mapper
```
