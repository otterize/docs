...
```bash
curl -LJO https://get.otterize.com/otterize-cli/v0.1.10/otterize_macOS_arm64_notarized.zip
...
```bash
curl -LJO https://get.otterize.com/otterize-cli/v0.1.10/otterize_macOS_x86_64_notarized.zip
...
```PowerShell
Invoke-WebRequest -Uri https://get.otterize.com/otterize-cli/v0.1.10/otterize_Windows_x86_64.zip -OutFile otterize_Windows_x86_64.zip
...
```PowerShell
Invoke-WebRequest -Uri https://get.otterize.com/otterize-cli/v0.1.10/otterize_Windows_i386.zip -OutFile otterize_Windows_i386.zip
...
```bash
wget https://get.otterize.com/otterize-cli/v0.1.10/otterize_Linux_x86_64.tar.gz
...
```bash
wget https://get.otterize.com/otterize-cli/v0.1.10/otterize_Linux_i386.tar.gz
...
```bash
wget https://get.otterize.com/otterize-cli/v0.1.10/otterize_Linux_arm64.tar.gz
