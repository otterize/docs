...
```bash
curl -LJO https://get.otterize.com/otterize-cli/v0.1.30/otterize_macOS_arm64_notarized.zip
...
```bash
curl -LJO https://get.otterize.com/otterize-cli/v0.1.30/otterize_macOS_x86_64_notarized.zip
