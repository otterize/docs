...
```bash
curl -LJO https://get.otterize.com/otterize-cli/v2.0.2/otterize_macOS_arm64_notarized.zip
...
```bash
curl -LJO https://get.otterize.com/otterize-cli/v2.0.2/otterize_macOS_x86_64_notarized.zip
...
```PowerShell
Invoke-WebRequest -Uri https://get.otterize.com/otterize-cli/v2.0.2/otterize_windows_x86_64.zip -OutFile otterize_Windows_x86_64.zip
...
```bash
wget https://get.otterize.com/otterize-cli/v2.0.2/otterize_linux_x86_64.tar.gz
