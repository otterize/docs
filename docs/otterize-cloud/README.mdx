...
Otterize Cloud provides a cloud-based control plane for deploying and managing [intents-based access control (IBAC)](https://docs.otterize.com/intent-based-access-control).
