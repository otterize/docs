...
These guides take you through [installing](/3-guides/1-k8s-installation.mdx) and using Otterize.
...
- [rolling out mTLS for pod-to-pod authentication](/3-guides/5-k8s-mtls/README.mdx), and
