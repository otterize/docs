...
when an intent will generate a network policy that can block external traffic. To disable this feature, consult the FIXME [documentation for the intents operator](/components/intents-operator)
