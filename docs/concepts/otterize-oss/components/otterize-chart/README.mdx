...
:::note
The [network mapper](concepts/otterize-oss/componentsnetwork-mapper) is not deployed by this chart. You can deploy it with [its own chart](concepts/otterize-oss/componentsnetwork-mapper/helm-chart).
:::end
...
Further information about the intents operator parameters can be found [in the Intents Operator's helm chart](concepts/otterize-oss/componentsintents-operator/helm-chart).
...
Further information about SPIRE integration operator parameters can be found [in the SPIRE integration operator chart](concepts/otterize-oss/componentsspire-integration-operator/helm-chart).
