...
The Otterize [Credentials operator](concepts/otterize-oss/componentscredentials-operator) automatically resolves pods to dev-friendly service names, registers them with a SPIRE server, and provisions credentials as a Kubernetes Secrets.
