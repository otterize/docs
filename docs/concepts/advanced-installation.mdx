---
sidebar_position: 1
title: Installing Otterize in Kubernetes - advanced
---
...
For a complete list of the Helm values the chart accepts, consult the [Helm chart documentation](concepts/otterize-oss/componentsintents-operator/helm-chart).
