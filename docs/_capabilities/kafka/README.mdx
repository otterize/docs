...
[documentation](reference/configuration/credentials-operator/).
...
[Read more about Kafka configuration here.](reference/configuration/intents-operator/configuration).
