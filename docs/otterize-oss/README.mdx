...
The Otterize OSS code base and issues are managed [on GitHub](https://github.com/otterize).and

To get started with Otterize OSS, see the [quick tutorials](/tutorials) or the [more in-depth guides](/guides).
