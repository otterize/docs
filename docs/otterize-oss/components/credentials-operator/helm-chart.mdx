...
---
You can use the [SPIRE integration operator's Helm chart](https://github.com/otterize/helm-charts/tree/main/credentials-operator) to deploy the SPIRE integration operator on its own, and configure a SPIRE server for it to work with according to the parameters value.
